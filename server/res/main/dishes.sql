...
-- command: stats.get_all
SELECT * FROM dish_stats
ORDER BY id DESC

-- command: choices.get_all
SELECT * FROM dish_choices 
ORDER BY id DESC

-- command: get_from_category
